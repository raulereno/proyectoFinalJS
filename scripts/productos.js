...
listaDeProductos.push(new Producto("Cepillo de Dientes",150,10,2,"https://lh3.googleusercontent.com/pw/AM-JKLXJMzTGldW5xNwaZKGWSSD4KjgHq49BVjiWq6yUElFkUmFW5O7t8NgW4vBDFEq1HdyLPcc2vh-oq_Y6IuA5AfUIL79ZiJDBEInkTFK5SURbNqVjV-qT7eVIxH1sjDFX1jX6XbH8Kl9hZ09EYTLDdAwFiA=w469-h625-no?authuser=0"));
listaDeProductos.push(new Producto("Hueso Grande",250,8,3,"https://lh3.googleusercontent.com/pw/AM-JKLXxP49wJrl7G5UjuZ3bG6ISTQT9jDtLYS7VwnyMy0e6e4q0YptNwC6WwMEMQMjyxXUJvcjnquzLzCYsYhCbg1YtRp2ZySygdRNdN6wNUUf1NDaz7BUJ0FehIl_ENO7On0rr7A0Z7Mp8Ozi2IYFTYatdCw=w469-h625-no?authuser=0"));
listaDeProductos.push(new Producto("Shampoo Antiparasitario",350,10,4,"https://lh3.googleusercontent.com/pw/AM-JKLUS2SUqsr_lZF5n3VoPD3LUEiuj9GsgygozagdHEoKZlxIK-22NLhT2i-zYbIDS4-06vQF6rQ1NqZQ0XwC8jacGYRf3jzrTELO6FnF5aBc8I7K2KW4gnPTr-UqgmD6HCKbEMqZ7JK3Xq4r7Ipr9E5g2ug=w469-h625-no?authuser=0"));
listaDeProductos.push(new Producto("Corta Uñas",500,5,5,"https://lh3.googleusercontent.com/pw/AM-JKLVHhTENPzao2Jk5HkDFtOKCsOZWQfTmHqeUofR0E5VYOLjfPuusHpji24jFmVb3LQlTeAnSPHonIjq5mDY3dDEB7fpTUZah4I7DEJQpTWWL3EHFpPiC_pAdm9NiK5PBTjqQo8cFIdOyIWL18wdct0TxOw=w469-h625-no?authuser=0"));
listaDeProductos.push(new Producto("Collar con Cascabel",400,11,6,"https://lh3.googleusercontent.com/pw/AM-JKLWwUguxM2pSyJ01XsdzOJ4fKLcBCegfAQfMWIS9oNn6wEU-ODgUURwa2d4uNXKt7NUSt06wIENX-M89Zw71oY4-Wq1ZHgAy1-xVBmhgvvmqBeiroZLzhKGZ5XMjRrT5xDaH7zhJSvwDxzvgXC8y59oUaA=w469-h625-no?authuser=0"));
...
function crearCards(){
    ...
    for(const producto of listaDeProductos){
        ...
        <div class="card-body">
            ...
            <p id="stock${producto.codigo}">Stock: ${producto.stock}</p>
