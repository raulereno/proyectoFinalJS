...
let botonFinalizar = $("#finalizarCompra").click((e) => {
    finalizarCompra();
})
...
function comprobarLocalStorage() {
    if (localStorage.getItem("carritoPersistencia") != null) {
        ...
        for (const producto of carrito) {
            ...
            $(`#basura${producto.codigo}`).click((e) => {
...
function agregarAlCarro(producto) {
    ...
    $(`#${producto.codigo}`).css("background", "green").fadeOut(800, () => {
        ...
        $(`#${producto.codigo}`).html("Agregar a carrito")
    }).fadeIn(800, () => {
...
function finalizarCompra() {
    ...
    //Actualizo la informacion del DOM
...
function eliminarProducto(codigo) {
    ...
    //Condicional que comprueba si existe mas de un mismo producto en carrito y lo elimina uno a uno
    ...
    cantidad = cantidad - 1;
    //Llamado a funcion que actualiza el DOM
    cantidadYTotalProds();
}
